...
def main():
    ...
    palette.setColor(CR.AlternateBase, QColor(245, 245, 245)) # Set alternate base color to light gray
    ...
    palette.setColor(CR.Button, QColor(245, 245, 245))        # Set button background color to light gray
