...
(
  ID_CONTADOR integer GENERATED ALWAYS AS IDENTITY (START WITH 1) NOT NULL,
  ...
  CONSTRAINT UNQ_EQUIPO_FECHA UNIQUE (ID_EQUIPO,FECHA)
);
CREATE TABLE EQUIPOS
(
  ID_EQUIPO integer GENERATED ALWAYS AS IDENTITY (START WITH 1) NOT NULL,
...
ALTER TABLE CONTADORES ADD CONSTRAINT FK_CONTADORES_EQUIPO
...
GRANT INSERT, SELECT, UPDATE
    ON CONTADORES TO ROLE ADMINISTRADOR, VENDEDOR;

GRANT INSERT, SELECT, UPDATE
    ON EQUIPOS TO ROLE ADMINISTRADOR, VENDEDOR;
